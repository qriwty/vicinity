package com.lada.vicinity.modelviewer.stl

import com.lada.vicinity.modelviewer.ArrayModel
import com.lada.vicinity.utils.ModelViewerUtils
import com.lada.vicinity.utils.ModelViewerUtils.calculateNormal
import java.io.*
...
class StlModel(inputStream: InputStream) : ArrayModel() {
    ...
    private fun readBinary(inputStream: BufferedInputStream) {
        ...
        val vectorSize: Int = ModelViewerUtils.readIntLe(tempBytes, 0)
        ...
        for (i in 0 until vectorSize) {
            ...
            x = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 0))
            y = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 4))
            z = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 8))
            ...
            x = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 12))
            y = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 16))
            z = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 20))
            adjustMaxMin(x, y, z)
            centerMassX += x.toDouble()
            centerMassY += y.toDouble()
            centerMassZ += z.toDouble()
            ...
            x = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 24))
            y = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 28))
            z = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 32))
            adjustMaxMin(x, y, z)
            centerMassX += x.toDouble()
            centerMassY += y.toDouble()
            centerMassZ += z.toDouble()
            ...
            vertexArray[vertexPtr++] = y
            vertexArray[vertexPtr++] = z
            x = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 36))
            y = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 40))
            z = java.lang.Float.intBitsToFloat(ModelViewerUtils.readIntLe(tempBytes, 44))
            adjustMaxMin(x, y, z)
            centerMassX += x.toDouble()
            centerMassY += y.toDouble()
            centerMassZ += z.toDouble()
